...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_NO,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                         KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    CW_TOGG,
        KC_NO,  MT(MOD_LALT, KC_A), MT(MOD_LCTL, KC_S), MT(MOD_LGUI, KC_D), MT(MOD_LSFT, KC_F), KC_G,   KC_H,    MT(MOD_RSFT, KC_J), MT(MOD_LGUI, KC_K), MT(MOD_LCTL, KC_L), MT(MOD_LALT, KC_SCLN), KC_NO,
        KC_NO,  KC_Z,    KC_X,    KC_C,    LT(3, KC_V), KC_B,                     KC_N,    KC_M,    KC_COMMA,KC_DOT,  KC_SLASH, KC_NO,
                                                    KC_SPC, LT(2,KC_TAB),         LT(1, KC_BSPC), KC_ENT
    ),
    [1] = LAYOUT(
