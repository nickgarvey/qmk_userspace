...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_TAB,  MT(MOD_LALT, KC_A), MT(MOD_LCTL, KC_S), MT(MOD_LGUI, KC_D), MT(MOD_LSFT, KC_F), KC_G,   KC_H,    MT(MOD_RSFT, KC_J), MT(MOD_LGUI, KC_K), MT(MOD_LCTL, KC_L), MT(MOD_LALT, KC_SCLN), KC_QUOT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    LT(3, KC_V), KC_B,                                           KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                          KC_TRNS, KC_TRNS, MO(3), KC_SPC, LT(2, KC_TAB),                              LT(1, KC_BSPC), KC_ENT, KC_TRNS, KC_TRNS, KC_TRNS
    ),
    [1] = LAYOUT(
